...
(function () {
  ...
  if (cmd === "cp") {
    copyFiles(sourceRootDir, `${targetRootDir}/react-context-menu/lib`);
    ...
    rootFiles.forEach((file) => {
      ...
      if (stats.isFile()) {
        fs.copyFileSync(file, `${targetRootDir}/react-context-menu/${file}`);
      }
    });
    ...
    const packageJsonPath = path.resolve(__dirname, '../@ihatecode/react-context-menu/package.json');
